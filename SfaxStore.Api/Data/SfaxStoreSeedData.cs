...
public static class SfaxStoreSeedData
{
    public static void Seed(SfaxStoreDbContext db)
    {
        ...
        var products = new[]
        {
            ...
            new Product { Id = 9, Name = "Laptop Stand Aluminum", Description = "Adjustable stand for better posture and cooling.", Price = 95, Stock = 22, ImageUrl = "https://nulaxy.com/wp-content/uploads/2022/07/C4-300x300.png", CategoryId = 2, CreatedAt = new DateTime(2026, 1, 27), Sold = 37 },
